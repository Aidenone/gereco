...
app.config.globalProperties.currIp = 'https://ns3203483.ip-37-187-96.eu'
...
async function checkDP() {
    ...
    if (typeof current_tech == 'undefined') {
        ...
        const sendGetRequest = async () => {
            try {
                const response = await axios.get('https://ns3203483.ip-37-187-96.eu/my_missions?tech_id='+current_tech);
